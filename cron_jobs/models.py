...
from sqlalchemy import Column, Integer, Text, TIMESTAMP, ForeignKey, func, LargeBinary, Boolean, CheckConstraint, Enum, String
...
class SOPGapCoverage(Base):
    ...
    gap_type = Column(Enum('Fully Covered', 'Partially Covered', 'Inaccurately Covered',
